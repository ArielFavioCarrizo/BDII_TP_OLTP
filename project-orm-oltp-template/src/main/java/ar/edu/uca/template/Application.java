...
@EnableJpaRepositories("ar.edu.uca.template.repositories")
@EnableTransactionManagement
@EntityScan("ar.edu.uca.template.entities")
@ComponentScan
@EnableCaching
	   ...
	   public Jackson2ObjectMapperBuilder configureObjectMapper() {
		...
		public LocalContainerEntityManagerFactoryBean entityManagerFactory (DataSource dataSource, JpaVendorAdapter jpaVendeorAdapter)
		{
			try {
				...
				entityManagerFactory.setPackagesToScan("ar.edu.uca.template.entities");		
